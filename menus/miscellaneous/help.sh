...
menu_miscellaneous_help ()
{
    ...
    text_white "    lets you create alias so you can start Commander by inputting “commander” instead of “bash ./commander.sh” from anywhere within your current SSH session."
    echo
